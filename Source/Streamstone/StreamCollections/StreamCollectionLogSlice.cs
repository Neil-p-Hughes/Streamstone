namespace Streamstone.StreamCollection
{
    ...
    public sealed class StreamCollectionLogSlice<T> where T : class, new()
    {
        /// <summary>
        ...
        internal StreamCollectionLogSlice(StreamCollectionLog stream, T[] events, int startVersion, int sliceSize)
        {
            Stream = stream;
            Events = events;
